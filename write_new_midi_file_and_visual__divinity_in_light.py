...
random.seed(198966681901) #datetime.now()) #1987
...
def build_music():
    ...
    length_int_time = 120
    tempo = 8640/length_int_time #int(80*0.9391) #192/2     # In BPM
    beats_per_measure = 6
    ...
    midi_file.addProgramChange(base_track, base_channel, 0, 
        midi_instrument_numbers.tubular_bells) #pan_flute) #tubular_bells) #acoustic_grand_piano)
    ...
    with open('divinity_in_light.mid', 'wb') as output_file:
