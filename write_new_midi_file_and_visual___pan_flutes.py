...
def build_music():
    ...
    beats_per_measure = 6
    selected_chord_progression = chords.chord_progression_aFCG #chord_progression_CFGF #chord_progression_CGaF
    ...
    midi_file.addProgramChange(top_1_track, top_1_channel, 0, 
        midi_instrument_numbers.pan_flute) #acoustic_grand_piano) #string_ensemble_2)
    ...
    midi_file.addProgramChange(top_3_track, top_3_channel, 0, 
        midi_instrument_numbers.pan_flute) #tubular_bells)
    ...
    for cycle_index_1 in range(number_of_cycles_1):
        ...
        percussion_chord = [notes.NOTE_C4] #, notes.NOTE_D4, notes.NOTE_E4, notes.NOTE_F4]
