...
def main():
    ...
    tempo = 192/2     # In BPM
    beats_per_measure = 6
    selected_chord_progression = chords.chord_progression_CGaF
    number_of_cycles_1 = 4
    ...
    midi_file.addProgramChange(percussion_track, percussion_channel, 0, midi_instrument_numbers.woodblock)
    
    base_track, base_channel, base_volume = 1, 1, 70
    midi_file.addProgramChange(base_track, base_channel, 0, midi_instrument_numbers.acoustic_grand_piano)
    
    top_1_track, top_1_channel, top_1_volume = 2, 2, 90
    midi_file.addProgramChange(top_1_track, top_1_channel, 0, midi_instrument_numbers.acoustic_grand_piano)
    
    top_2_track, top_2_channel, top_2_volume = 3, 3, 80
    midi_file.addProgramChange(top_2_track, top_2_channel, 0, midi_instrument_numbers.acoustic_grand_piano)
    ...
    for cycle_index_1 in range(number_of_cycles_1):
        ...
        base_durations = [1, 1, 0.5, 0.5, ('rest',0.5), 0.25, 0.25, 1, 1]
        ...
        top_2_durations = top_track_durations_sample[2:] + top_track_durations_sample[:2]
